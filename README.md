...
| # | File | Concepts |
|---|------|----------|
| 1 | `01_variables_types.py` | Dynamic typing, str/int/float/bool/None, `type()` |
| 2 | `02_strings.py` | f-strings, `.strip()/.split()/.join()`, slicing `[:5]`, `[::-1]` |
| 3 | `03_lists.py` | List CRUD, slicing, sort, list comprehensions (vs `Select`/`Where`) |
